    ...
    <div className={`relative ${className}`}>
      ...
      <div className="flex rounded-lg border border-slate-300 bg-white">
        <input
          ...
          className="w-full rounded-l-lg bg-white px-3 py-2 text-sm text-black placeholder:text-slate-400 focus:outline-none"
        />
        <button
          type="button"
          aria-label="Відкрити список"
          {...getToggleButtonProps()}
          className="rounded-r-lg px-2 text-slate-600 hover:bg-slate-100"
        >
          ▾
        </button>
      </div>
            ...
            <table className="min-w-full table-fixed border-collapse text-left text-sm">
              <thead className="sticky top-0 bg-slate-50 text-slate-600">
                <tr className="[&>th]:px-4 [&>th]:py-3 [&>th]:font-medium text-center">
                  ...
                  <th className="w-[40%]">ПІБ</th>
                  <th className="w-[10%]">Номер Кімнати</th>
